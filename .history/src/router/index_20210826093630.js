...
const BackStageArticleItems = () =>
    import ('views/backStageManagement/BackStageArticleItems')
const routes = [{
        path: '',
        redirect: '/home'
    },
    ...
    },
    {
        ...
        children: [{
            ...
            {
                path: 'backstagearticleitems',
                name: 'BackStageArticleItems',
                component: BackStageArticleItems
            }
        ]
    },
    {
