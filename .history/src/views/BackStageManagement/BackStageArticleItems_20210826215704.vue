    ...
    <div class="container">
      ...
      <div class="btn">
        <el-button type="primary"
                   class="audit"
                   @click="audit(item.blogsId)">{{item.status}}</el-button>
        <el-button type="danger"
                   class="delete"
                   @click="remove(item.blogsId)">删除</el-button>
      </div>
    </div>
  </div>
</template>
...
<script>
import { articleAudit, articleRemove, loadArticles } from '@/netWork/require'
