  ...
  methods: {
    publish () {
      let publishNotice = {
        ...
        noticeContent: this.notice.content,
        dateTime: this.notice.date1 + this.notice.date2
      }
      console.log(publishNotice.dateTime);
      // publishNewNotice(this.$qs.stringify(publishNotice)).then(res => {
      //   console.log(res);
      // }).catch(err => {
      //   console.log(err);
      // })
