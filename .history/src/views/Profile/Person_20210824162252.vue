...
import { upaDataUserPhoto } from '@/netWork/require'
...
export default {
  ...
  methods: {
    ...
    upDataPhoto () {
      console.log(71 + this.previewImg)
      this.cropper.getCroppedCanvas().toBlob(file => {
        //console.log(file);
        this.previewImg = window.URL.createObjectURL(file)
        console.log(75 + this.previewImg)
        // console.log(newPhoto)
        const formData = new FormData();
        formData.append('photo', file);
        // upaDataUserPhoto(formData).then(res => {
        //   console.log(res);
        // }).catch(err => {
        //   console.log(err);
        // })
      })
      console.log(85 + this.previewImg)
