...
import { loadArticles, getOneComment } from '@/netWork/require'
...
export default {
  ...
  created () {
    ...
    getOneComment(this.$qs.stringify({ blogsId: this.blogsId })).then(res => {
